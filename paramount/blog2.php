<?php
/*
   Template Name: Paramount Blog 2
 */
?>
        ...
        <div class="servicescontainer">
            ...
            <div class="content2">
                ...
                <div class="blog2container">
                    ...
                    <!-- FIRST BLOG BLOCK -->
                    <div class="blog2topcontent"> 
                        <div class="blog2topcontentleft">
                        ...
                        <div class="blog2topcontentright">
                        </div>
                    </div>

                    <!-- SECOND BLOG BLOCK -->
                    <div class="blog2middlecontent">
                        ...
                        <div class="blog2middlecontentright">
                        </div>
                    </div>
                    ...
                    <div class="blog2middlecontent">
                        ...
                        <div class="blog2bottomcontentright">                               
                        </div>
                    </div> 
