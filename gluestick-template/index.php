...
<head>
	<meta charset="utf-8" />
	<title>Gluestick Marketing</title>
...
<body>
	...
	<div class="row">
		<div class="topbar">
			...
			<a href="" class="lastmenu">Contact Us</a>
		</div>
	</div>

	<div class="row">
		<div class="main">
			<div class="randomwhite">
			</div>
			<div class="textbig">
		...
		<div class="row">
			...
			<div class="icons columns">
				...
				<img src="<?php
					echo get_template_directory_uri();
					?>
					/images/icon2.png" id="cogs" />
			</div>

			<div class="infotext columns">
		...
		<div class="row">
			<div class="icons columns">
				...
				<img src="<?php
					echo get_template_directory_uri();
					?>
					/images/icon4.png" id="letter" />
			</div>

			<div class="infotext columns">
				<h2>gluestick marketing</h2>
				<h3>
					4542 ruffner st. suite 170 <br />
					san diego ca, 92111
				</h3>
				<h4>
					123.456.7890 <br />
					nicole@gluestickmarketing.com
				</h4>
			</div>
		</div>
	...
	<div class="row">
		<div class="checkout columns">
			<div class="checkusout">
				<h5>don't forget to check out our blog  &nbsp; &#187;</h5>
			</div>
