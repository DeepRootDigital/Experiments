...
<aside class="sub-page-right-menu">
	<div class="side-menu top">
		<img src="<?php echo get_template_directory_uri(); ?>/images/atf-arrow.png" />
	...
	<div class="side-menu bottom">
		...
		<img class="side-bottom" src="<?php echo get_template_directory_uri(); ?>/images/qtf-white-arrow.png" />
	</div>
</aside>
