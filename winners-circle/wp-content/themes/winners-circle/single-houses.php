			...
			<div class="sub-left">
				<section>
					...
					<div class="sub-left-features">
						...
						<li><?php echo get_post_meta( get_the_ID(), 'feature1', true ); ?></li>
						<li><?php echo get_post_meta( get_the_ID(), 'feature2', true ); ?></li>
						<li><?php echo get_post_meta( get_the_ID(), 'feature3', true ); ?></li>
					</div>
				</section>
				<div class="floor-plan">
					...
					global $wpdb;
					$images = get_post_meta( get_the_ID(), 'floorplan', false );
					$images = implode( ',' , $images );
