...
<head>
    ...
    <script type="text/javascript" src="http://fast.fonts.net/jsapi/2eb5388c-a2e1-484e-9e76-02c6f4deb0fc.js"></script>
        ...
        <div class="submenu">
            <div class="container">
                ...
                $args = array(
                    ...
                    <div class="dropdown-bigbluetriangle">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/dropdown-trianglepointer.png" />
                    </div>
                    <div class="subnav-items">
                        <div class="dd-text">Al Khan Foods</div>
                        <div class="dropdown-title-shadow">
