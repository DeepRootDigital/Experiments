            ...
            <div class="recipeswrapper">
                ...
                <div class="recipe">
                    ...
                    <div class="recipemore">
                        <a class="sngl-button">recipe <span style="font-weight:bold; padding-top:2px; padding-left:6px;">+</span></a>
                    </div>
                    <div class="recipemeta">
                        <div class="metablock"><img src="<?php echo get_template_directory_uri(); ?>/images/clock.png" /><?php echo get_post_meta(get_the_ID(), 'esttime', true); ?></div>
                        <div class="metablock" style="border:none;"><img src="<?php echo get_template_directory_uri(); ?>/images/graph.png" /><?php echo get_post_meta(get_the_ID(), 'estcalories', true); ?></div>
                    </div>
                    <div class="recipeline"></div>
                    <div class="recipe-lb" id="<?php echo get_the_ID(); ?>">
