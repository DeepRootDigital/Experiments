        ...
        <div id="slideFrame">
            <ul>
               ...
               <li>
                ...
                <div class="slider-overlay"><h2>This looks really good right?</h2></div>
            </li>
            <?php } ?>
            <?php if ($options['sliderimg2'] !== '') { ?>
            <li>
                <img width="600" height="360" src="<?php echo $options['sliderimg2']; ?>" alt="">
                <div class="slider-overlay"><h2>This looks really great right?</h2></div>
            </li>
            <?php } ?>
            <?php if ($options['sliderimg3'] !== '') { ?>
            <li>
                <img width="600" height="360" src="<?php echo $options['sliderimg3']; ?>" alt="">
                <div class="slider-overlay"><h2>This gregre really good right?</h2></div>
            </li>
            <?php } ?>
