...
<body>
	...
	<div class="container">
		<div class="top-section">
			<img class="vivioptal-intro-text" src="images/vivioptal.png" alt="vivioptal" />
			<div class="e-book-info">
				...
				<p>vitamin b</p>
				<p>complex</p>
				<img class="dotted-divider-full" src="images/dotted-divider-full.png" alt="dotted-divider-full" />
				<img class="dotted-divider-half" src="images/dotted-divider-half.png" alt="dotted-divider-half" />
				<img class="solid-divider" src="images/solid-divider.png" alt="solid-divider" />
			</div>
			<img class="vivio-box-image" src="images/vivio-box-image.png" alt="vivio-box-image" />
		...
		<div class="bottom-section">
			<div class="bottom-section-intro-text">
				...
				<img class="bottom-section-intro-divider" src="images/bottom-section-intro-divider.png" alt="bottom-section-intro-divider" />
			</div>
		...
		<div class="footer-items">
			...
			<img class="footer-divider" src="images/footer-divider.png" alt="footer-divider" />
